...
num_data = 100
X_train_list = X_train_list[:num_data]
X_test_list = X_test_list[:num_data]
y_train = y_train[:num_data]
y_test = y_test[:num_data]
...
model.fit(
    train_dataset.shuffle(num_data).batch(32), epochs=1, batch_size=64,
    validation_data=val_dataset.shuffle(num_data).batch(64),
